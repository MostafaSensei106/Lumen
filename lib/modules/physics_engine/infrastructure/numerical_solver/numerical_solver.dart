...
class NumericalSolver {
  ...
  /// 1. dr/ds = w / n(r)
  /// 2. dw/ds = grad_n(r)
  static SystemState stepRK4(SystemState y, double ds, MetamaterialField field) {
    ...
    SystemState yK2 = SystemState(
      y.r + k1.r * (ds / 2),
      y.w + k1.w * (ds / 2),
    );
    SystemState k2 = f(yK2);

    SystemState yK3 = SystemState(
      y.r + k2.r * (ds / 2),
      y.w + k2.w * (ds / 2),
    );
    SystemState k3 = f(yK3);

    SystemState yK4 = SystemState(
      y.r + k3.r * ds,
      y.w + k3.w * ds,
    );
