...
RouteBase get $levelsRoute => GoRouteData.$route(
  path: '/levels',
  hasOverriddenOnExit: false,
  factory: $LevelsRoute._fromState,
);

mixin $LevelsRoute on GoRouteData {
  static LevelsRoute _fromState(GoRouterState state) => const LevelsRoute();

  @override
  String get location => GoRouteData.$location('/levels');
